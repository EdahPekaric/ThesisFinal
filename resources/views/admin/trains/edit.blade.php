        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <br />
                    <form method="post" action="{{ route('trains.update', $data->id) }}" enctype="multipart/form-data" class="col-md-5">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="version" value="{{ $data->version }}" class="form-control input-lg" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4">Enter Number of Seats</label>
                            <div class="col-md-8">
                                <input type="text" name="number_of_seats" value="{{ $data->number_of_seats }}" class="form-control input-lg" />
                            </div>
                        </div>
                        <div class="form-group">
